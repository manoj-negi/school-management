...
func (f AcademicYearFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AcademicYearMutation); ok {
		return f(ctx, mv)
	}
...
// The FeePaymentFunc type is an adapter to allow the use of ordinary
// function as FeePayment mutator.
type FeePaymentFunc func(context.Context, *ent.FeePaymentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FeePaymentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FeePaymentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FeePaymentMutation", m)
}

// The FeeStructureFunc type is an adapter to allow the use of ordinary
// function as FeeStructure mutator.
type FeeStructureFunc func(context.Context, *ent.FeeStructureMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FeeStructureFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FeeStructureMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FeeStructureMutation", m)
}
...
// The StudentAttendanceFunc type is an adapter to allow the use of ordinary
// function as StudentAttendance mutator.
type StudentAttendanceFunc func(context.Context, *ent.StudentAttendanceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StudentAttendanceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StudentAttendanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StudentAttendanceMutation", m)
}
...
// The TeacherAttendanceFunc type is an adapter to allow the use of ordinary
// function as TeacherAttendance mutator.
type TeacherAttendanceFunc func(context.Context, *ent.TeacherAttendanceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TeacherAttendanceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TeacherAttendanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TeacherAttendanceMutation", m)
}
