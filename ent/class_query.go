...
func (_q *ClassQuery) QueryAcademicYear() *AcademicYearQuery {
...
func (_q *ClassQuery) QueryDepartment() *DepartmentQuery {
...
func (_q *ClassQuery) WithAcademicYear(opts ...func(*AcademicYearQuery)) *ClassQuery {
	query := (&AcademicYearClient{config: _q.config}).Query()
...
func (_q *ClassQuery) WithDepartment(opts ...func(*DepartmentQuery)) *ClassQuery {
	query := (&DepartmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ClassQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Class, error) {
	...
	if query := _q.withAcademicYear; query != nil {
		if err := _q.loadAcademicYear(ctx, query, nodes, nil,
			func(n *Class, e *AcademicYear) { n.Edges.AcademicYear = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ClassQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAcademicYear != nil {
			_spec.Node.AddColumnOnce(class.FieldAcademicYearID)
		}
		if _q.withDepartment != nil {
			_spec.Node.AddColumnOnce(class.FieldDepartmentID)
		}
	}
