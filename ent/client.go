...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.FeePayment, c.FeeStructure, c.Student, c.StudentAttendance, c.Subject,
		c.Task, c.Teacher, c.TeacherAttendance, c.User,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		FeeStructure, Student, StudentAttendance, Subject, Task, Teacher,
		TeacherAttendance, User []ent.Hook
	}
	inters struct {
		AcademicYear, Class, Department, Employee, Event, Exam, FeePayment,
		FeeStructure, Student, StudentAttendance, Subject, Task, Teacher,
		TeacherAttendance, User []ent.Interceptor
	}
)
